                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="display:block">
                        <div class="province-name" title="Download in Excel">
                            ...
                            <a style="font-weight:normal; font-size:11px" href="<?php echo e(url('province?download=no&model=1&province=' . $key->province)); ?>" title="Logarithmic Time Trend">LOG</a> <span style="font-weight:normal">|</span> <a style="font-weight:normal; font-size:11px; color:green" href="<?php echo e(url('province?download=no&model=2&province=' . $key->province)); ?>" title="Annualized Growth Rate">AGR</a>
                        </div>
                    </div>
                    <table>
                        <tbody>
                            <?php $__currentLoopData = $key->commodities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="commodity-name" style="width:20%"><?php echo e($k->commodity); ?></td>
                                    <td class="crop-type" style="width:20%"><?php echo e($k->crop_type); ?></td>
                                    <td><?php echo e(($k->remarks != null) ? $k->remarks : ''); ?></td>
                                    <td class="actions">
                                        <a href="<?php echo e(url($k->crop_data_filename)); ?>" style="white-space:nowrap" title="Download the file"><i class="fas fa-file-download"></i>Commodity Data</a>
                                        <a href="<?php echo e(url($k->pop_data_filename)); ?>" style="white-space:nowrap" title="Download the file"><i class="fas fa-file-download"></i>Population Growth Rate</a>
