                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                        <tr>
                            ...
                            <td style="text-align:center; font-weight:bold; font-size:11px; text-transform:uppercase">
                                <a href="<?php echo e(route('users.edit', $key)); ?>" style="color:green; margin-right:4px; padding-right:5px; border-right:1px solid #ddd">Edit</a>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marklesterbolotaolo/Desktop/laravel/nfcqs1/resources/views/users.blade.php ENDPATH**/ ?>