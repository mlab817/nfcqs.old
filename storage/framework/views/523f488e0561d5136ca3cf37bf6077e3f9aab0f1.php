...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <h1 class="page-title"><i class="fas fa-info-circle"></i> Contracts Summary by Region</h1>
        ...
        <div style="display:block">
            <table style="width:700px; margin:20px">
                <thead>
                    <tr>
                        <th rowspan="2" style="max-width:200px">Region<br /><span style="color:#888; font-weight:normal; text-transform:none">*click region name for provincial level summary*</span></th>
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><a href="<?php echo e(url('report/province?region=' . $key)); ?>" style="display:inline-block; color:orange;"><?php echo e($key); ?></a></td>
