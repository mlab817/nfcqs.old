...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <h1 class="page-title"><i class="fas fa-info-circle"></i> Forecast Results for <?php echo e($crop->commodity); ?> of <?php echo e($crop->province); ?></h1>
        <div style="width:100%">
            <div class="row">
                <div class="col-12">
