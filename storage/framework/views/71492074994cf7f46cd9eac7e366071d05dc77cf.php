<div class="modal fade" id="popupForm" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo Form::open(['url' => 'uploads.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'accept-charset' => 'UTF-8', 'id' => 'commodityForm', 'class' => 'popup-form x-load-file']); ?>
...
</div><?php /**PATH /Users/marklesterbolotaolo/Desktop/laravel/nfcqs/resources/views/uploads/index.blade.php ENDPATH**/ ?>