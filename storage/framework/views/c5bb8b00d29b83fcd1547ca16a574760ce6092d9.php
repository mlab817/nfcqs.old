<div class="modal fade" id="popupForm" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document" style="width:800px">
            <div class="modal-content">
                <?php echo Form::open(['url' => 'contract/planted-species', 'method' => 'post', 'enctype' => 'multipart/form-data', 'accept-charset' => 'UTF-8', 'id' => 'uploadPayments', 'class' => 'popup-form x-load-file', 'data-goto' => urldecode($goto)]); ?>

                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Upload Planted Species</h4>
