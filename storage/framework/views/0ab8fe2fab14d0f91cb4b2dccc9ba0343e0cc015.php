...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <h1 class="page-title"><i class="fas fa-info-circle"></i> Contracts Summary by Sub-Watershed</h1>
        ...
        <div style="display:block">
            <table style="width:700px; margin:20px">
                <thead>
                    <tr>
                        <th rowspan="2" style="max-width:200px">Sub-Watershed<br /><span style="color:#888; font-weight:normal; text-transform:none">*click sub-watershed name for list of contracts*</span></th>
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><a href="<?php echo e(url('contracts?search=' . $key)); ?>" style="display:inline-block; color:orange;"><?php echo e($key); ?></a></td>
