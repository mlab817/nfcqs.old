...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <?php echo Form::open(['url' => 'profile-project', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'x-load-file profile-form', 'id' => 'projectProfile', 'data-goto' => url('project-list'), 'style' => 'max-width:500px']); ?>
            ...
            <div class="form-group-wrapper">
                ...
                <div class="row" style="display:<?php echo e((@$profile['project_type_id'] < 7) ? 'block' : 'none'); ?>">
                    <label>Project Name | Title</label>
                    <?php echo Form::text('project_title', @$profile['project_title'], ['class' => 'form-control']); ?>

                </div>
                <div class="row" style="display:<?php echo e((@$profile['project_type_id'] < 7) ? 'none' : 'block'); ?>">
                    <label>People's Organization</label>
                    <?php echo Form::select('po_name', $pos, @$profile['po_id'], ['class' => 'form-control']); ?>

                </div>
                <div class="row proponent-lgu" style="display:<?php echo e((@$profile['project_type_id'] < 7) ? 'block' : 'none'); ?>">
                    <div class="col-6" style="padding:0 10px 0 0">
            ...
            <div class="form-group-wrapper infra-beneficiaries" style="display:<?php echo e((@$profile['project_type_id'] < 7) ? 'block' : 'none'); ?>">
                <div class="row form-subtitle-wrapper">
            ...
            <div class="form-group-wrapper other-beneficiaries" style="display:<?php echo e((@$profile['project_type_id'] < 7) ? 'none' : 'block'); ?>">
                <div class="row form-subtitle-wrapper">
